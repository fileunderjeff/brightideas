...
function ap_user_display_name($args = array()) {
	...
	if ( $user_id > 0 ) {
		...
		if ( ! $html ) {
			...
			$return = '<span class="who">A City of Houston Employee Submitted This Idea</span>';
			// <a href="'.ap_user_link( $user_id ).'">'.$user->display_name.'</a>
		}
...
function ap_user_display_meta($html = false, $user_id = false, $echo = false) {
	...
	$metas['display_name'] = 'A City employee posted this idea:';
// <span class="ap-user-meta ap-user-meta-display_name">'. ap_user_display_name( array( 'html' => true ) ) .'</span>
	/**
