...
class AnsPress_Vote_Ajax extends AnsPress_Ajax {
	...
	public function subscribe() {
		...
		if ($is_subscribed) {
			...
			if (FALSE !== $row) {
				ap_send_json(ap_ajax_responce(array('message' => 'unsubscribed', 'action' => 'unsubscribed', 'container' => '#subscribe_'.$action_id.' b', 'do' => 'updateHtml', 'html' => __('Follow idea', 'ap'))));
			...
			ap_send_json(ap_ajax_responce(array('message' => 'subscribed', 'action' => 'subscribed', 'container' => '#subscribe_'.$action_id.' b', 'do' => 'updateHtml', 'html' => __('Unfollow idea', 'ap'))));
